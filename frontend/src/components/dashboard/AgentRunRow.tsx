                ...
                <tr style={{ background: 'var(--bg-base)' }}>
                    <td colSpan={5} style={{ padding: '0 16px 16px' }}>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                            {run.error_message && (
                                <div style={{ gridColumn: '1/-1', background: 'var(--red-dim)', border: '1px solid rgba(239,68,68,0.2)', borderRadius: 8, padding: 12 }}>
                            ...
                            {run.output && (
                                <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 8, padding: 12 }}>
                                    <div style={{ fontSize: '0.72rem', fontWeight: 700, color: 'var(--text-muted)', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '0.06em' }}>Output</div>
                                    <pre style={{ fontSize: '0.78rem', color: 'var(--text-secondary)', overflow: 'auto', maxHeight: 160 }}>
